...
// 初始化地图,设置中心点坐标和地图级别
//var point = new BMap.Point(117.128205, 36.681824);
map.centerAndZoom("中国", 6);
// 设置地图显示的城市 此项是必须设置的
//map.setCurrentCity("山东");
//开启鼠标滚轮缩放
...
setIcon("../images/orangeShadow.png");
setIcon("../images/blueShadow.png");
setIcon("../images/blueShadow.png");
setIcon("../images/blueShadow.png");
setIcon("../images/orangeShadow.png");
setIcon("../images/blueShadow.png");
setIcon("../images/greenShadow.png");
setIcon("../images/greenShadow.png");
setIcon("../images/greenShadow.png");
setIcon("../images/greenShadow.png");
setIcon("../images/orangeShadow.png");
...
for (var i = 0, l = blocMap.icon.length; i < l; i++) {
    var opt = {title: '', offset: new BMap.Size(140, 40)};
    blocMap.opts.push(opt);
}
//console.log(blocMap.opts);
/**
 * 模板函数
 * @param name 项目名称
 * @param city 城市
...
//// 创建Map实例
//var map = new BMap.Map("comMap",{minZoom:8,maxZoom:12});
//// 初始化地图,设置中心点坐标和地图级别
//var point = new BMap.Point(117.128205,36.681824);
...
//}
//var dataList = [
//    ["北苑小区", "山东青岛", "青岛新时代", "完工", 268, 4, 4, 3],
//    ["万丽海景", "山东青岛", "和展", "完工", 298, 5, 4, 4],
//    ["泉星小区", "山东济南", "济发", "完工", 258, 4, 3, 3],
//    ["中海国际社区", "山东济南", "中海物业", "完工", 265, 4, 4, 3],
//    ["华辉东方城", "山东威海", "华辉", "完工", 288, 5, 4, 4],
//    ["香港平远国际城", "山东威海", "丽诚物业", "完工", 270, 4, 4, 4],
//    ["华乐公馆", "山东烟台", "烟台华乐置业", "完工", 255, 4, 3, 3],
//    ["美航康悦城", "山东烟台", "北京美航金达莱", "在建", 300, 5, 5, 5],
//    ["中节能健康城", "河北石家庄", "河北乐水房地产", "在建", 300, 5, 5, 5]
//]
////设置图标
//setIcon("../images/blueShadow.png");
//setIcon("../images/blueShadow.png");
...
//        "<div style='color:white;font-size: 18px;line-height: 36px;padding: 10px 0 0 10px;float: left;width: 240px;height:36px;clear: both;'>" +
//        "<ul style='width: 240px;float: left'>" +
//        "<li style='height: 36px;line-height: 36px;float: left'>项目名称：" + "<span>" + arguments[0][0] + "</a></li>" +
//        "<li style='height: 36px;line-height: 36px;float: left'>项目城市：" + "<span>" + arguments[0][1] + "</span></li>" +
//        "<li style='height: 36px;line-height: 36px;float: left'>项目集团：" + "<span>" + arguments[0][2] + "</span></li>" +
//        "<li style='height: 36px;line-height: 36px;float: left'>项目状态：" + "<span>" + arguments[0][3] + "</span></li>" +
//        "</ul>";
//    return str;
//}
//
