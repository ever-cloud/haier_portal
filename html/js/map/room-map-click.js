...
//地图自适应
<!-- 注:在body中调用onresize="resizeMap()"没有地图不需要写,会报Wr错误-->
...
function create() {
    ...
    var str = "<div class='myItem' style='height: 160px;width: 240px;background: #1F5294; border-radius: 6px 6px 6px 6px;'>" +
        ...
        "<li style='height: 36px;line-height: 36px;float: left'>社区名称：" + "<span>" + arguments[0][0] + "</a></li>" +
        "<li style='height: 36px;line-height: 36px;float: left'>社区城市：" + "<span>" + arguments[0][1] + "</span></li>" +
        "<li style='height: 36px;line-height: 36px;float: left'>社区集团：" + "<span>" + arguments[0][2] + "</span></li>" +
        "<li style='height: 36px;line-height: 36px;float: left'>社区状态：" + "<span>" + arguments[0][3] + "</span></li>" +
        "</ul>";
    return str;
}
