getechart("ecHouse_total", "themeFour", {
    title: {
        x: 'left',
...
getechart("ecHome_total", "themeFour", {
    title: {
        x: 'left',
...
getechart("ecExcellent_total", "theme", {
    "title": {
        "text": "月销售趋势图",
        "x": "10%"
    },
...
getechart("ecEducation_total", "theme", {
    "title": {
        "text": "90天商户类别分布",
        "top": "30",
        "x": "center"
...
getechart("ecGender_total", "themeNine", {
    "title": {
        "text": "性别分布",
        "x": "10%"
        //"y":"10%"
...
getechart("ecAge_total", "themeTen", {
    "title": {
        "text": "年龄分布",
        "x": "left"
    },
