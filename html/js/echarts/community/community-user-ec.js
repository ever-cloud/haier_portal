getechart("ecHousenew", "themeFour",{
    title: {
        x: 'left',
    ...
    series: [
        {
            ...
            data: [1000, 1200, 1280, 2000, 2378, 2600, 3000, 3235, 3320, 3400, 3890]

        }

    ]
});
getechart("ecHomenew", "themeFour", {
    title: {
        x: 'left',
...
getechart("eccombottomnew", "theme",{
...
getechart("ecEducationnew", "theme",{
    "title": {
        "text": "90天商户类别分布",
        "top": "30",
        "x": "center"
...
getechart("ecGendernew", "themeNine",{
    "title": {
        "text": "性别分布",
        "x": "15%",
        "y":"1%"
